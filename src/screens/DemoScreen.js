    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
          ...
          {/* Exemplo 1: Switch com State */}
          <View style={styles.demoCard}>
            <Text style={styles.demoTitle}>Exemplo de Switch</Text>
            <Text style={styles.demoDescription}>
              Este exemplo mostra como um componente Switch controla o estado 
              da aplicação, alterando dinamicamente o estilo.
            </Text>
          ...
          {/* Exemplo 3: Contador com múltiplos states */}
          <View style={styles.demoCard}>
          ...
          {/* Exemplo 4: Seleção de Cores */}
          <View style={styles.demoCard}>
            <Text style={styles.demoTitle}>Seleção de Cores</Text>
            <Text style={styles.demoDescription}>
              Este exemplo demonstra como gerenciar uma seleção entre múltiplas opções
              e aplicar o valor selecionado em tempo real.
            </Text>
          ...
          {/* Exemplo 5: Slider */}
          <View style={styles.demoCard}>
            <Text style={styles.demoTitle}>Exemplo de Slider</Text>
            <Text style={styles.demoDescription}>
              Este exemplo mostra como usar um slider para controlar valores
              contínuos e aplicar transformações em tempo real.
            </Text>
          ...
          {/* Botão para mais exemplos */}
          <TouchableOpacity 
            style={styles.moreExamplesButton}
            onPress={toggleModal}
          >
            <Text style={styles.moreExamplesButtonText}>
              Ver Mais Exemplos
            </Text>
            <Ionicons name="chevron-down" size={20} color={theme.COLORS.text.link} />
          </TouchableOpacity>
            ...
            <View style={styles.modalOverlay}>
              <View style={styles.modalContent}>
                ...
                <Text style={styles.modalText}>
                  Em um aplicativo real, aqui você encontraria exemplos adicionais
                  de componentes e funcionalidades React Native.
                </Text>
